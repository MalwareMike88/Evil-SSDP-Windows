...
def process_args():
    ...
    parser.add_argument('-s', '--smb', type=str, action='store',
                        help=('IP address of your SMB server. Defalts to the '
                              'primary address of the IP provided.'))
...
def print_details(args, local_ip, smb_server):
    ...
    print(PC.ok_box + "MSEARCH LISTENER:        {}".format(args.ip))
...
# Used in main, must stay here for global variable so pickling will work
upnp = UPNPObject
